...
namespace M05_UF3_P2_Template.App_Code.Model
{
    public class Product
    {
        ...
        public void Fill(DataRow row)
        {
            ...
            Name = row[3].ToString();
            Icon = row[4].ToString();
            Banner = row[5].ToString();
            Trailer = row[6].ToString();
            try
            {
            ...
            try
            {
                Publishing = DateTime.Parse(row[8].ToString());
            }
            catch
            {
            ...
            try
            {
                Size = float.Parse(row[9].ToString());
            }
            catch
            {
                Size = 0;
